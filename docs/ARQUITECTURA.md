...
GeVet usa Next.js App Router, React Server Components por defecto y Supabase PostgreSQL. Las tablas operativas llevan `tenant_id` y sus políticas comparan el valor con `public.tenant_id()`, resuelto desde el JWT o desde la relación del usuario autenticado.
